...
# ID: 2200010825
#
# Here's my code for the iaddq instruction
# 
#  ==================================================================
#  |	State	| iaddq V, rB 			| jm rB, V					|
#  ------------------------------------------------------------------
#  |  	Fetch	| icode: ifunc <- M1[PC]| icode: ifunc <- M1[PC]	|
#  |  	Fetch	| rA: rB <- M1[PC+1]	| rA: rB <- M1[PC+1]		|
#  |  	Fetch	| valC <- M8[PC+2]		| valC <- M8[PC+2]			|
#  |	Fetch	| valP <- PC + 10		| valP <- PC + 10			|
#  ------------------------------------------------------------------
...
word aluA = [
	...
	icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJM, IIADDQ } : valC;
